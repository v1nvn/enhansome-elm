...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 435,650 | 🐛 67 | 📅 2026-01-28 [![Build Status](https://app.travis-ci.com/sporto/awesome-elm.svg?branch=master)](https://app.travis-ci.com/sporto/awesome-elm)
...
* [Elm test](https://github.com/elm-explorations/test) ⭐ 240 | 🐛 94 | 🌐 Elm | 📅 2026-02-06 - Unit and fuzz tests
...
* [OpenApi Generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,759 | 🐛 5,576 | 🌐 Java | 📅 2026-02-07 - Generate OpenApi types for Elm.
* [Quicktype](https://github.com/quicktype/quicktype) ⭐ 13,605 | 🐛 555 | 🌐 TypeScript | 📅 2025-10-27 - Generate JSON decoders and encoders from JSON
...
* [Elm Watch](https://github.com/lydell/elm-watch) ⭐ 181 | 🐛 19 | 🌐 TypeScript | 📅 2026-01-31 - `elm make` in watch mode. Fast and reliable.
...
* [emmet-vim](https://github.com/mattn/emmet-vim) ⭐ 6,463 | 🐛 134 | 🌐 Vim Script | 📅 2025-07-15 - Markup expansion with elm support.
...
* [Iced](https://github.com/hecrj/iced) ⭐ 29,399 | 🐛 394 | 🌐 Rust | 📅 2026-02-06 - A cross-platform GUI library for Rust, inspired by Elm
...
* [Roc](https://github.com/roc-lang/roc) ⭐ 5,474 | 🐛 196 | 🌐 Zig | 📅 2026-02-07 - A language that targets WebAssembly and machine code inspired by Elm.
* [Miso](https://github.com/dmjio/miso) ⭐ 2,366 | 🐛 20 | 🌐 Haskell | 📅 2026-02-06 - A library that provides The Elm Architecture in Haskell.
* [Lustre](https://github.com/lustre-labs/lustre) ⭐ 2,124 | 🐛 16 | 🌐 Gleam | 📅 2026-02-06 - A library that provides The Elm Architecture in Gleam.
...
* [Fabulous](https://github.com/fsprojects/Fabulous) ⭐ 1,247 | 🐛 13 | 🌐 F# | 📅 2025-11-14 - F# Functional App Development, using declarative dynamic UI
* [Elchemy](https://github.com/wende/elchemy) ⚠️ Archived - Write Elixir code using statically-typed Elm-like syntax
* [Elmish](https://github.com/elmish/elmish) ⭐ 889 | 🐛 8 | 🌐 F# | 📅 2026-01-02 - Elm-like abstractions for F# apps
...
* [Flame](https://github.com/easafe/purescript-flame) ⭐ 317 | 🐛 5 | 🌐 PureScript | 📅 2026-01-25 - A library that provides The Elm Architecture in PureScript.
