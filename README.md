...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 435,879 | 🐛 68 | 📅 2026-01-28 [![Build Status](https://app.travis-ci.com/sporto/awesome-elm.svg?branch=master)](https://app.travis-ci.com/sporto/awesome-elm)
...
* [Architecture Tutorial](https://github.com/evancz/elm-architecture-tutorial) ⭐ 4,180 | 🐛 10 | 🌐 Elm | 📅 2019-12-30 - How to create modular Elm code that scales nicely with your app.
...
* [Elm test](https://github.com/elm-explorations/test) ⭐ 240 | 🐛 94 | 🌐 Elm | 📅 2026-02-07 - Unit and fuzz tests
...
* [OpenApi Generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 25,765 | 🐛 5,575 | 🌐 Java | 📅 2026-02-07 - Generate OpenApi types for Elm.
* [Quicktype](https://github.com/quicktype/quicktype) ⭐ 13,608 | 🐛 555 | 🌐 TypeScript | 📅 2025-10-27 - Generate JSON decoders and encoders from JSON
...
* [Elm CodeGen](https://github.com/mdgriffith/elm-codegen) ⭐ 142 | 🐛 18 | 🌐 Elm | 📅 2026-01-20 - Generate Elm code
...
* [Travelm Agency](https://github.com/andreasewering/travelm-agency) ⭐ 47 | 🐛 10 | 🌐 Elm | 📅 2026-02-05 - Generate typesafe Elm code from translation files
...
* [Elm SPA Example](http://rtfeldman.github.io/elm-spa-example/) - Full stack Elm app w/ CRUD operations, Auth, routing, pagination and more. [Code](https://github.com/rtfeldman/elm-spa-example) ⭐ 3,307 | 🐛 49 | 🌐 Elm | 📅 2023-11-03 / [Article](https://dev.to/rtfeldman/tour-of-an-open-source-elm-spa) / [Video](https://youtu.be/RN2_NchjrJQ)
...
* [TodoMVC/Firebase](https://github.com/ThomasWeiser/todomvc-elmfire) ⭐ 60 | 🐛 1 | 🌐 Elm | 📅 2016-06-16 - Fork of TodoMVC demonstrating start-app, [The Elm Architecture](https://github.com/evancz/elm-architecture-tutorial) ⭐ 4,180 | 🐛 10 | 🌐 Elm | 📅 2019-12-30 and Firebase as backend.
...
* [Iced](https://github.com/hecrj/iced) ⭐ 29,403 | 🐛 394 | 🌐 Rust | 📅 2026-02-06 - A cross-platform GUI library for Rust, inspired by Elm
...
* [Roc](https://github.com/roc-lang/roc) ⭐ 5,477 | 🐛 200 | 🌐 Zig | 📅 2026-02-08 - A language that targets WebAssembly and machine code inspired by Elm.
* [Miso](https://github.com/dmjio/miso) ⭐ 2,366 | 🐛 20 | 🌐 Haskell | 📅 2026-02-07 - A library that provides The Elm Architecture in Haskell.
* [Lustre](https://github.com/lustre-labs/lustre) ⭐ 2,125 | 🐛 17 | 🌐 Gleam | 📅 2026-02-07 - A library that provides The Elm Architecture in Gleam.
...
* [Fabulous](https://github.com/fsprojects/Fabulous) ⭐ 1,248 | 🐛 13 | 🌐 F# | 📅 2025-11-14 - F# Functional App Development, using declarative dynamic UI
